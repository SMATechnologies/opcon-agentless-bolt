...
public abstract class AbstractAgentlessBoltUnixSubJobDetailsWidget extends AbstractSubJobsDetailsWidget {

	private BatchUserSelector _uidSelector;

	public AbstractAgentlessBoltUnixSubJobDetailsWidget(Composite parent, IMessageDisplayer messageManager, ContextID context) {
	...
	/**
	 * Get the parameters value. You can override this
	 * method.
	 * 
	 * @return the empty string by default.
	 */
